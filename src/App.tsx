...
export default function App() {
  ...
  return (
    <div className="h-screen bg-black text-white font-sans flex flex-col overflow-hidden">
      ...
      <main className="relative z-[20] w-full max-w-md mx-auto h-full flex flex-col p-4 gap-4">
        {/* Compressed Header */}
        <header className="relative text-center shrink-0 min-h-[48px] flex items-center justify-center">
          <button 
            onClick={() => setMode('intake')}
            className="absolute left-0 top-1/2 -translate-y-1/2 p-4 text-[#66FFB2] hover:bg-[#66FFB2]/10 rounded-full transition-all active:scale-90 z-50"
        ...
        <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border-2 border-[#333] bg-[#080808] shadow-[0_0_20px_rgba(0,0,0,0.8)] shrink-0 z-[30]">
          <Webcam
            audio={false}
            muted
            playsInline
